...
namespace EHFleetXRechnung.Schemas
{
    ...
    [XmlRootAttribute("INVOICINGPERIODType")]
    public class InvoicingPeriod
    {
        [XmlElement("Invoicingperiodstartdate")]
        public Date Invoicingperiodstartdate { get; set; }
        [XmlElement("Invoicingperiodenddate")]
        ...
        {
            Invoicingperiodenddate = new Date();
            Invoicingperiodstartdate = new Date();
        }
    }
}