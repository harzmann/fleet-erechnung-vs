...
namespace EHFleetXRechnung.Schemas
{
    ...
    [XmlTypeAttribute(Namespace = "urn:ce.eu:en16931:2017:xoev-de:kosit:standard:xrechnung-1", TypeName = "identifier")]
    [XmlRootAttribute("identifier")]
    public class Identifier
    {
        ...
        [XmlAttribute(AttributeName = "schemeidentifier")]
        public string Schemeidentifier { get; set; }
        [XmlAttribute(AttributeName = "schemeversionidentifier")]
