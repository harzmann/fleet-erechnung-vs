...
namespace EHFleetXRechnung.Schemas
{
    ...
    [XmlRootAttribute("PRECEDINGINVOICEREFERENCEType")]
    public class PrecedingInvoiceReference
    {
        [XmlElement("PrecedingInvoicereference")]
        public DocumentReference PrecedingInvoicereference { get; set; }
        [XmlElement("PrecedingInvoiceissuedate")]
        ...
        {
            PrecedingInvoiceissuedate = new Date();
            PrecedingInvoicereference = new DocumentReference();
        }
    }
}