...
namespace EHFleetXRechnung.Schemas
{
    ...
    [XmlRootAttribute("INVOICELINEPERIODType")]
    public class InvoiceLinePeriod
    {
        [XmlElement("Invoicelineperiodstartdate")]
        public Date Invoicelineperiodstartdate { get; set; }
        [XmlElement("Invoicelineperiodenddate")]
        ...
        public InvoiceLinePeriod()
        {
            Invoicelineperiodenddate = new Date();
            Invoicelineperiodstartdate = new Date();
        }
    }
}