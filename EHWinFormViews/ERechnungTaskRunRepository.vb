...
(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"
        ...
        Using cmd As New OleDbCommand(sql, Conn())
            ...
            Dim ts As DateTime = If(e IsNot Nothing AndAlso e.Timestamp <> DateTime.MinValue, e.Timestamp, DateTime.UtcNow)
            cmd.Parameters.Add(New OleDbParameter With {.OleDbType = OleDbType.DBTimeStamp, .Value = ts})
        ...
        Using cmd As New OleDbCommand(sql, Conn())
            ...
            Using da As New OleDbDataAdapter(cmd)
                ...
                For Each r As DataRow In dt.Rows
                    ...
                    If dt.Columns.Contains("LogTimestampUtc") AndAlso Not IsDBNull(r("LogTimestampUtc")) Then
                        e.Timestamp = CType(r("LogTimestampUtc"), DateTime)
                    End If
